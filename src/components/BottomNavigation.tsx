                ...
                {orderedPages.map((page) => {
                    ...
                    return (
                        <Button
                            key={page.id}
                            variant="ghost"
                            className={`flex flex-1 flex-col items-center justify-center gap-1 rounded-xl py-2 h-auto ${isActive
                                ? "text-brand-navy"
                        ...
                        >
                            <div
                                className={`rounded-full p-1 transition-colors ${isActive ? "bg-brand-lime/20" : "bg-transparent"
                                    }`}
                            >
